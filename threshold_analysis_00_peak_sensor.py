...
if __name__ == "__main__":
	...
	for subject in subjectIDs:
		...
		#crop to the prestim time range
		epochs.crop(tmin=-1.25, tmax=-0.25)

		# get raw data from epoch. this gives one spectrogram for every trial
		epochData = np.squeeze(epochs.get_data(['MEG0221']))
	...
	df_plot.to_csv(dataDir + 'single_sensor_shin_threshold.csv')	
